                ...
                <div className='grid grid-cols-3 gap-6'>
                    ...
                    <div className='col-span-full flex flex-col p-6 justify-center items-start bg-white rounded-lg shadow-md w-full gap-4 min-h-46.25'>
                        ...
                        <div className='flex justify-between items-center w-full gap-4 flex-1'>
                            <button className='flex flex-col btn btn-soft p-4 flex-1 h-full text-[18px] hover:bg-[#1a3b2d] hover:text-white'><LuPhoneCall />Call</button>
                            <button className='flex flex-col btn btn-soft p-4 flex-1 h-full text-[18px] hover:bg-[#1a3b2d] hover:text-white'><BsChatText />Text</button>
                            <button className='flex flex-col btn btn-soft p-4 flex-1 h-full text-[18px] hover:bg-[#1a3b2d] hover:text-white'><LuVideo />Video</button>
                        </div>
                    </div>
                </div>
